...
# 基础设置
PATH_ORIGINAL_DATA = "../2-hw/datasets/C1-P1_Train-copy/2/"
imglist = os.listdir(PATH_ORIGINAL_DATA)
count = len(imglist)
# print("count", count)
PATH_OUTPUT_DATA = "C1-P1_Train/2/"
...
for i in range(1):
  ...
  r = results[0]
  visualize.display_instances(image, r['rois'], r['masks'], r['class_ids'], class_names, filestr, PATH_OUTPUT_DATA, r['scores'], show_bbox=False, show_mask=True, captions=False)
